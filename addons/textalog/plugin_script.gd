...
var event_scripts := PoolStringArray([
	...
	"res://assets/events/change_background.gd",
	"res://assets/events/play_music.gd",
	"res://assets/events/shake_screen.gd",
	"res://assets/events/character_panning.gd",
	# Case Maker
	"res://assets/events/evidence.gd",
	"res://assets/events/debate/debate.gd",
])
